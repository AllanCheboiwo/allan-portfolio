  ...
  return (
    <nav className="fixed top-0 w-full bg-gray-800 shadow-lg z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        <Link to={process.env.PUBLIC_URL + '/'} className="text-2xl font-bold text-yellow-400">
          Allan Cheboiwo
        </Link>
        <div className="hidden md:flex space-x-6">
          <Link to={process.env.PUBLIC_URL + '/'} className="hover:text-yellow-400 transition">
            Home
          </Link>
          ...
          <Link to={process.env.PUBLIC_URL + '/blog'} className="hover:text-yellow-400 transition">
            Blog
          </Link>
